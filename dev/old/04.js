...
/** globals **/
  ...
  function matchOptionToTile(val) { // match 
  ...
  function getTileWalkability(array) { // define hyrule grid tile values to correlating tile-values
    for(var i = 0; i < 4; i++) {
    	...
    	console.log(gridWalkability[array[i][0]]);
    	console.log(gridWalkability.indexOf(array[i][0]));
    ...
    console.log("walkability status array : " +walkabilityStatus);
