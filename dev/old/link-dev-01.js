...
function locateLink(){ // locateLink function is center for link's functionality. all functions go through here.
  ...
  convertOptionsToTileValues(optionTileValues); // convert movement options to tile dictionary values from hyrule grid
  //console.log("option tile definitions: " +optionTileValues);
