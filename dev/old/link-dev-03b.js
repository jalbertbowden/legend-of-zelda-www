...
function moveLinkAndTileNorth(){ // move link one current screen grid value north, while simultaneously changing the current screen to the one above (north) of it
  ...
  let screenGridNorth = document.getElementById("offscreen-grid-north");
  ...
  //let newID = screenGridNorth.dataset.screenGridTile;
  //console.log("new id: " +newID);
  
  screenGridCurrent.id = "offscreen-grid-south";
...
// console.log(htmlLinkCSSPositionValues);
  //updateLink(htmlScreenGridTileID, newCSSPositionValues);
  updateLink();
  //locateLink();
  //console.log("locate link fired off....is it updated???");
...
function moveLinkAndTileSouth(){
  ...
  let screenGridSouth = document.getElementById("offscreen-grid-south");
  let screenGridCurrent = document.getElementById("ul-screen-grid");
  screenGridSouth.id = "ul-screen-grid";
  screenGridCurrent.id = "offscreen-grid-north";
  console.log("ids swapped!");
  screenGridNorth.appendChild(htmlLink);
  htmlLink.style.setProperty("top", "0px"); // 304 (336-32 = 304) is last position in array at 32px aspect ratio scale; 320 takes half height of last row into account
...
function linkMovementWest() {
  	//console.log("west grid array value: " +htmlLinkScreenGridPositions[1]+ ", type: " +typeof htmlLinkScreenGridPositions[1]);
  	//console.log("west grid hyrule grid column: " +hyruleGridColumn+ ", type of: " +typeof hyruleGridColumn);
