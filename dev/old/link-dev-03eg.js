...
function linkMovementEast() { // console.log("east: walkability option: " +walkabilityOptions[1]+ ", html link screen grid positions: " +htmlLinkScreenGridPositions[1]);
  if ((walkabilityOptions[1] == true) && (htmlLinkScreenGridPositions[1] < 15)) { // console.log("walkability option east is true!");
    ...
    moveLinkAndTileEast(); // console.log("move tile east functionality!!!!!");
  }
