...
function linkMovementHidden(str){
  ...
  var screenToGet = tileGridOptionsValues.door.entranceTo;
  console.log(tileGridOptionsValues.door.entranceTo);
...
function linkMovementNorth(){ // move north options cycle
  var hiddenMoveNorth = isEqual(tileGridOptionsValues.door.gridPosition,movementOptions[0]);
