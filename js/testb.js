...
function correlateGridLocations(gridLocationCoords, direction) {
	...
	//console.log("y: " +zzz);
	console.log("x: " +yyy+ ", y: " +zzz+ ", direction: " +direction);
/**	
**	
**
...
**/
	...
	gridLocationCoordsX = parseGridVar[yyy]; // console.log("glcx: " +gridLocationCoordsX);
	gridLocationCoordsY = gridLocationCoordsX[zzz]; // console.log("glcy: " +gridLocationCoordsY);
	let gIDBase = gridActiveID();
	let gID = currentGridTileStringBase + gIDBase; // console.log("THIS VALUE: " +gID); // console.log("THIS VALUE: " +tileGrids[gID]);
